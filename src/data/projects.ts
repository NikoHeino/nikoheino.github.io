...
export const projects: Project[] = [
  ...
  },
  {
    ...
    media: [
        { kind: 'image', src: '/Assets/Media/NeonSign/img_NeonSign_Unreal01', alt: 'Sign in unreal 01' },
        { kind: 'image', src: '/Assets/Media/NeonSign/img_NeonSign_Unreal02', alt: 'Sign in unreal 02' },
        { kind: 'image', src: '/Assets/Media/NeonSign/img_NeonSign_RealLife01', alt: 'Sign in real life 01' },
        { kind: 'image', src: '/Assets/Media/NeonSign/img_NeonSign_RealLife02', alt: 'Sign in real life 02' },
    ],
  ...
  },
    {
        ...
        tags: ['Blender', 'Substance Painter'],
        media: [
            { kind: 'image', src: '/Assets/Media/HighEndBar/img_HighEndBar001', alt: 'High End Bar 1' },
            { kind: 'image', src: '/Assets/Media/HighEndBar/img_HighEndBar002', alt: 'High End Bar 2' },
            { kind: 'image', src: '/Assets/Media/HighEndBar/img_HighEndBar003', alt: 'High End Bar 3' },
        ],
        links: [{ label: 'GitHub', href: '#' }],
        featured: true,
    },
