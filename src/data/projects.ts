...
export const projects: Project[] = [
  ...
  },
  {
    ...
    media: [
        { kind: 'image', src: '/Assets/Media/NeonSign/img_NeonSign_Unreal01.png', alt: 'Sign in unreal 01' },
        { kind: 'image', src: '/Assets/Media/NeonSign/img_NeonSign_Unreal02.png', alt: 'Sign in unreal 02' },
        { kind: 'image', src: '/Assets/Media/NeonSign/img_NeonSign_RealLife01.png', alt: 'Sign in real life 01' },
        { kind: 'image', src: '/Assets/Media/NeonSign/img_NeonSign_RealLife02.png', alt: 'Sign in real life 02' },
    ],
  ...
  },
    {
        ...
        description:
            'Modeled and designed a high-end bar environment.',
        role: 'Solo · 3D Art',
        year: '2026',
        tags: ['Blender', 'Substance Painter'],
        media: [
            { kind: 'image', src: '/Assets/Media/HighEndBar/img_HighEndBar001.png', alt: 'High End Bar 1' },
            { kind: 'image', src: '/Assets/Media/HighEndBar/img_HighEndBar002.png', alt: 'High End Bar 2' },
            { kind: 'image', src: '/Assets/Media/HighEndBar/img_HighEndBar003.png', alt: 'High End Bar 3' },
        ],
        links: [{ label: 'GitHub', href: '#' }],
        featured: true,
    },
